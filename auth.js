...
const {
    TOKEN_PATH, // The file token.json stores the user's access and refresh tokens, and is created automatically when the authorization flow completes for the first time.
    CREDENTIALS_PATH,
} = process.env;

const SCOPES = ["https://www.googleapis.com/auth/spreadsheets"]; // If modifying these scopes, delete token.json.

export function readCredentialsAndAuthorize(callback) {
